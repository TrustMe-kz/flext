...
![trustme24_flext_abstract_painting.jpg](docs/trustme24_flext_abstract_painting.jpg)
...
![trustme24_flext_use_cases.jpg](docs/trustme24_flext_use_cases.jpg)
...
- [Repo: More information about the repo can be found in ARCHITECTURE.md](ARCHITECTURE.md)
...
[More information about the contribution can be found in CONTRIBUTING.md](CONTRIBUTING.md).
...
- **License:** Flext is released under the [MIT License](LICENSE)
